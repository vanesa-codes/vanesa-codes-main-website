...
img_gmail = Image.open("C:/Users/vnher/website/images/gmail_stock_img.jpg")
...
with st.container():
    ...
    with left_column:
        ...
        st.write(
            """
            I'm a Master's student in Applied Computer Science. My interests are process automation, machine learning, and data visualization. I'm also a fan of sports analytics and the use of data to predict human performance :chart_with_upwards_trend:

            When I'm not in front of a screen, I'm listening to podcasts, walking my dogs, exploring local record stores, reading memoirs, and going on adventures with my partner 🏳️‍🌈
            """
        )
    with right_column:
        st.write("##")
